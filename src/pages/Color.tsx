...
function Color() {
    ...
    const updateColorNameEvent = async (id: number, name: string) {
        const updatedColor = await updateColorName({ id, name });
        console.log(`El color ${updatedColor.id} ha cambiado a ${updatedColor.name}`);
    }
    updateColorNameEvent(1, 'Nuevo color');
